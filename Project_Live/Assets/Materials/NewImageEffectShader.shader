Shader "Hidden/NewImageEffectShader"
{
    Properties {
        ...
        _Alpha ("Alpha", Range(0,1)) = 1.0  // ←追加：マテリアルでalpha制御
    }   
    
    SubShader {
        Tags { 
            "RenderType"="Transparent"      // ←変更：Opaque→Transparent
            "Queue"="Transparent"           // ←追加：透明度対応キュー
            "IgnoreProjector"="True"
        }
        LOD 100
        Blend SrcAlpha OneMinusSrcAlpha    // ←追加：Alpha Blending有効
        ZWrite off                          // ←追加：Zバッファ書き込みオフ
        ...
        Pass {
            ...
            fixed4 frag (v2f i) : SV_Target {
                ...
                color.a = _Alpha;  // ←変更：固定1.0 → _Alphaで制御
